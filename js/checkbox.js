import{html as s,render as r}from"./lit-html.js";import c from"./supercomponent.js";import o from"./env.js";import{noop as a,parseDataset as d}from"./general.js";import l from"./soundscape.js";class n extends c{constructor(e){super();this.handleChange=e=>{const t=e.currentTarget;this.set({checked:t.checked}),this.model.callback(t.checked,t.name),t.checked?l.play("click"):l.play("hover")};this.model={label:"",required:!1,name:"",checked:!1,disabled:!1,callback:a,css:"",class:"",attributes:{},type:"check"},this.model=d(this.dataset,this.model),o.css("checkbox").then(()=>{this.set(e,!0),this.render()})}connected(){this.addEventListener("click",e=>{e.stopImmediatePropagation()})}getName(){return this.model.name}getValue(){return this.model.checked}validate(){let e=!0;return this.model.required&&!this.model.checked&&(e=!1),e}renderIcon(){switch(this.model.type){case"line":return s`<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        `;this.setAttribute("state",this.state),this.className=`checkbox js-input ${this.model.class}`,this.style.cssText=this.model.css,Object.keys(this.model.attributes).map(i=>{this.setAttribute(i,`${this.model.attributes[i]}`)}),r(t,this)}}o.bind("checkbox-component",n);export{n as default};
