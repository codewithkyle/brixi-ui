import{html as l,render as n}from"./lit-html.js";import o from"./supercomponent.js";import i from"./env.js";import{noop as r,parseDataset as c}from"./general.js";class a extends o{constructor(e){super();this.handleChange=e=>{const t=e.currentTarget;this.model.callback(t.checked)};this.model={label:"",required:!1,name:"",checked:!1,disabled:!1,callback:r,css:"",class:"",attributes:{}},this.model=c(this.dataset,this.model),i.css("radio").then(()=>{this.set(e,!0),this.render()})}getName(){return this.model.name}getValue(){return this.querySelector("input").checked}validate(){return!0}render(){const e=`${this.model.label.replace(/\s+/g,"-").trim()}-${this.model.name}`,t=l`
        ...
        `;this.setAttribute("state",this.state),this.className=`radio js-input ${this.model.class}`,this.style.cssText=this.model.css,Object.keys(this.model.attributes).map(s=>{this.setAttribute(s,`${this.model.attributes[s]}`)}),n(t,this)}}i.mount("radio-component",a);export{a as default};
