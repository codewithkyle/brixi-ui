import a from"./supercomponent.js";import{register as r}from"./messaging.js";import{html as t,render as l}from"./lit-html.js";import n from"./doc-viewer.js";customElements.define("docs-view",n);import c from"./resizer.js";customElements.define("iframe-resizer",c);import i from"./code-viewer.js";customElements.define("code-view",i);class d extends a{constructor(){super();this.switchView=e=>{const s=e.currentTarget.dataset.view;this.update({view:s})};this.state="IDLING",this.stateMachine={IDLING:{LOAD:"LOADING"},LOADING:{SUCCESS:"IDLING",FAIL:"ERROR"},ERROR:{LOAD:"LOADING"}},this.model={component:null,view:"demo"},this.inboxId=r("view",this.inbox.bind(this)),this.render()}inbox(e){const{data:o}=e;this.load(o)}async load(e){this.update({component:e,view:"demo"}),this.state!=="LOADING"&&this.trigger("LOAD")}renderContent(){switch(this.model.view){case"code":return new i(this.model.component);case"demo":return t`
                    <iframe-resizer>
                        <resize-container>
                            <resize-bar>
            ...
            <div class="block w-full h-screen scroll-y-auto px-1">
                <div class="w-full max-w-768 mx-auto block py-4">
                    ...
                    <p class=" mb-0.5 font-grey-700 font-sm line-normal">
                        ...
                        and
                        <a class="link" href="https://github.com/codewithkyle/supercomponent" target="_blank" rel="noopener">SuperComponents</a>. The lit-html library lets you
                        write HTML templates in JavaScript using template literals with embedded JavaScript expressions. lit-html identifies the static and dynamic parts of your
                        templates so it can efficiently update just the changed portions without using a virtual DOM. lit-html is not tied to any component model, it focuses only
                    ...
                    <p class=" mb-0.5 font-grey-700 font-sm line-normal">
                        There are two ways to use Brixi UI. You can install the UI components via NPM using the command
                        <code class="inline-block font-xs font-warning-700 bg-warning-100 px-0.25 radius-0.25">npm i -S brixi-ui</code>
                        or you can browse the source code of individual components using the menu on the left. Each component provides a default class export that can be
                        instanciated and appended to the DOM.
                    </p>
                    ...
                    <ul class="font-sm line-normal mb-4 list">
                        ...
                        <li>
                            Several pre-bundled 3rd party libraries such as lit-html, flatpickr, day.js, fuse.js, tooltips, pubsub, snackbar/toaster notifications, and modal
                            creation.
                        </li>
                    </ul>
                    ...
                    <p class=" mb-4 font-grey-700 font-sm line-normal">
                        Everybody, or maybe nobody. The Brixi UI design system is a tool I created to help myself create SPAs faster and easier. All of the components are licensed
                        under MIT. Feel free to download and use any component for any commercial/non-commercial project.
                    </p>

                    <h2 class="block font-grey-700 font-lg font-bold mb-0.5 line-normal">Why create yet another CSS/JS framework?</h2>
                    <p class=" mb-0.5 font-grey-700 font-sm line-normal">
                        ...
                        <a class="link" href="https://brixi.dev/" target="_blank" rel="noopener">Brixi</a>
                        CSS framework by listing every Tailwind CSS class I used along with a longer and somewhat incomplete list of the classes I didn't. From there I created a
                        list of classes/features I wanted in a utility-first CSS framework.
                    </p>
                    <p class=" mb-0.5 font-grey-700 font-sm line-normal">
                    ...
                    <p class=" mb-4 font-grey-700 font-sm line-normal">
                        ...
                        functions can be immediately invoked. This means you don't need to provide state/prop callbacks between components, just
                    ...
                    <p class=" mb-4 font-grey-700 font-sm line-normal">
                        ...
                        the server all you need to do is render the empty custom element with the corresponding data attributes. When the browser loads the component's JavaScript
                        the component will be automatically mounted and it will render it's content using the settings provided by the data attributes.
                    </p>
