            ...
            <div class="block w-full h-screen scroll-y-auto px-1">
                <div class="w-full max-w-768 mx-auto block py-4">
                    ...
                    <p class=" mb-0.5 font-grey-700 font-sm line-normal">
                        ...
                        creating and updating DOM and that's where SuperComponents come in.
                    </p>
                    <p class=" mb-0.5 font-grey-700 font-sm line-normal">
                    ...
                    <p class=" mb-0.5 font-grey-700 font-sm line-normal">
                        ...
                        or you can browse the source code of individual components using the menu on the left. Each component is contained in a seperate JavaScript file that
                        defines a custom HTML element that can be appended to the DOM.
                    </p>
