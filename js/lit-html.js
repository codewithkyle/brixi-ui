 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const B=typeof window<"u"&&window.customElements!=null&&window.customElements.polyfillWrapFlushCallback!==void 0,O=(s,e,t=null,n=null)=>{for(;e!==t;){const i=e.nextSibling;s.insertBefore(e,n),e=i}},P=(s,e,t=null)=>{for(;e!==t;){const n=e.nextSibling;s.removeChild(e),e=n}};/**
 * @license
