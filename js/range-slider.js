import{html as a,render as m}from"./lit-html.js";import s from"./env.js";import{default as o}from"./input.js";import{noop as u,parseDataset as d}from"./general.js";import{calcPercent as n}from"./numpy.js";class r extends o{constructor(t){super(t);this.handleInput=t=>{const i=t.currentTarget;let e=parseInt(i.value);isNaN(e)&&(e=this.model.min),e<this.model.min?e=this.model.max:e>this.model.max&&(e=this.model.max);const l=n(e,this.model.max);this.style.setProperty("--track-fill",`${l}%`),this.update({value:e}),this.model.callback(e)};this.handleBlur=t=>{const i=t.currentTarget;let e=parseInt(i.value);isNaN(e)&&(e=this.model.min),e<this.model.min?e=this.model.max:e>this.model.max&&(e=this.model.max);const l=n(e,this.model.max);this.style.setProperty("--track-fill",`${l}%`),this.update({value:e})};this.model={manual:!1,label:"",name:"",instructions:"",readOnly:!1,required:!1,disabled:!1,error:"",autocapitalize:"off",autocomplete:"off",icon:"",placeholder:"",value:t?.min??0,minlength:0,maxlength:9999,min:0,max:9999,step:1,css:"",class:"",callback:u,attributes:{}},this.model=d(this.dataset,this.model),s.css(["range-slider"]).then(()=>{this.set(t,!0),this.render()}),this.style.setProperty("--track-fill",`${n(t?.value??0,t.max)}%`)}validate(t=null,i=!1){return!0}renderManualInput(){let t;return this.model.manual?t=a`
                <input
