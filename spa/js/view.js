import a from"./supercomponent.js";import{register as l}from"./messaging.js";import{html as o,render as r}from"./lit-html.js";import i from"./doc-viewer.js";customElements.define("docs-view",i);import c from"./resizer.js";customElements.define("iframe-resizer",c);import n from"./code-viewer.js";customElements.define("code-view",n);import"./tabs.js";class d extends a{constructor(){super();this.switchView=e=>{const s=e.currentTarget.dataset.view;this.set({view:s})};this.switchTab=e=>{const t=e.detail.value;this.set({tab:t})};this.state="IDLING",this.stateMachine={IDLING:{LOAD:"LOADING"},LOADING:{SUCCESS:"IDLING",FAIL:"ERROR"},ERROR:{LOAD:"LOADING"}},this.model={component:null,view:"demo",tab:"overview"},this.inboxId=l("view",this.inbox.bind(this)),this.render()}inbox(e){const{data:t}=e;this.load(t)}async load(e){e==="mpa/"||e==="spa/"||e==="/"||(this.set({component:e,view:"demo"}),this.state!=="LOADING"&&this.trigger("LOAD"))}renderContent(){switch(this.model.view){case"code":return new n(this.model.component);case"demo":return o`
                    <iframe-resizer>
                        <resize-container>
                            <resize-bar>
                ...
                `;case"docs":return new i(this.model.component)}}connected(){const e=location.pathname.replace(/^\//,"").trim();this.load(e)}renderOverview(){return this.model.tab!=="overview"?"":o`
            <p class=" mb-2 font-sm line-normal">
                Brixi UI is a sleek & slender design system built on the
                <a class="link" href="https://brixi.dev/" target="_blank" rel="noopener">Brixi CSS framework</a>. The goal of Brixi UI is to provide
                <a class="link" href="https://kyleandrews.dev/" target="_blank">me</a> with a lightweight accessibility-conscious design system built on web standards such as ES
            ...
            <p class=" mb-4 font-sm line-normal">
                The Brixi UI design system is a personal component library I bulilt to assist with building web applications. All of the components are licensed under MIT. Feel
                free to download and use any component for any commercial/non-commercial project.
            </p>
            ...
            <p class=" mb-0.5 font-sm line-normal">
                ...
                that I often only used a handful of classes, such as font, text, border, background, margin, and padding. At the time I was working on a server-side rendered PHP
                project and I decided it would be easier to create my own lightweight utility-first CSS framework than it would be to figure out how to use
            ...
            <p class=" mb-4 font-sm line-normal">
                ...
                without the overhead of the virtual DOM. Super Components separate the components state and model allowing developers to define and trigger state transitions
                without touching the components data model.
            </p>
            ...
            <p class=" mb-4 font-sm line-normal">
                ...
                for a while. They provide native component mount/unmount functionality and with the way Web Components bind to the DOM nodes they can be queried and their functions
                can be immediately invoked from the element(s) returned from the query. This means you don't need to provide state/prop callbacks between components, just
            ...
            <p class=" mb-4 font-sm line-normal">
                Contributions are welcome, however, this is my personal design system. Any contributions are likely to be subject to scrutiny and multiple revisions until I feel
                like the component fits the look and feel of the overall design system.
            </p>
        ...
        `}renderSPA(){return this.model.tab!=="spa"?"":o`
            <p class=" mb-0.5 font-sm line-normal">
            ...
            <p class=" mb-0.5 font-sm line-normal">
                The lit-html library renders HTML templates in JavaScript using template literals with embedded JavaScript expressions. lit-html identifies the static and dynamic
                HTML to efficiently update just the changed portions without using a virtual DOM. lit-html is not tied to any component model, it focuses only on creating and
                updating DOM.
            </p>
            <p class=" mb-0.5 font-sm line-normal">
            ...
            <p class=" mb-0.5 font-sm line-normal">
                If you're interested in learning more about lit-html or xstate you can watch the videos below where the authors of each library provide insights and a deep dive
                into the inner workings of their projects.
            </p>
            ...
            <ul class="font-sm line-normal mb-4 list">
                ...
                <li>
                    An enviroment class which can be used to bootstrap new components or load CSS along with other goodies such as browser detection, global loading state tracking,
                    and network type detection.
                </li>
                <li>
                    A soundscape class which provides generic sound effects such as hover, tap, notifications, and toggles along with methods to load, play, pause, and disable
                    custom audio files.
                </li>
            ...
            <p class=" mb-0.5 font-sm line-normal">
                ...
                You could also browse the source code of individual components using the menu on the left. Each component is contained within separate JavaScript files that define
                a custom HTML element as a Web Component.
            </p>
            <p class=" mb-4 font-sm line-normal">
        ...
        `}renderMPA(){return this.model.tab!=="mpa"?"":o`
            <p class=" mb-2 font-sm line-normal">
                ...
                <a class="link" href="https://github.com/codewithkyle/lazy-loader" target="_blank" rel="noopener">Lazy Loader</a> but also works well with libraries like
                <a class="link" href="https://htmx.org/" target="_blank" rel="noopener">HTMX</a>.
            </p>

            <h2 class="block font-lg font-bold mb-0.5 line-normal">Installing Brixi UI.</h2>
            <p class=" mb-0.5 font-sm line-normal">
                The MPA version of Brixi UI components can be added into your project by including the HTML, CSS, and occasionally JavaScript files into your project. The source
                code for each component is available in "Source" viewer mode.
            </p>
...
&lt;/script&gt;
            ...
            <p class=" mb-0.5 font-sm line-normal">
                With the dependencies squared away you can begin adding components by switching the site into "MPA" mode using the button located at the top right of the site. Then
                click into a component from the menu on the left. After demoing the component you can switch to "Source" viewer mode to see the HTML, CSS, and JavaScript required
                to use the component in your project. Note that only a few components require JavaScript most of the client side functionality is implemented with Alpine.
            </p>
        `}render(){let e=o`
            <div class="block w-full h-screen scroll-y-auto px-1 pb-4">
                <div class="w-full max-w-768 mx-auto block py-4">
                    ...
                    ></brixi-tabs>
                    ${this.renderOverview()} ${this.renderSPA()} ${this.renderMPA()}
                </div>
            </div>
        `;this.model.component&&(e=o`
            ...
            `),r(e,this),document.body.querySelectorAll("pre code").forEach(t=>{hljs?.highlightElement(t)})}}export{d as default};
