            ...
            default:
                view = html`
                    <div flex="row nowrap items-center" class="mb-1">
                        <a href="/" class="mr-0.5" flex="row nowrap items-center">
                            <img src="/logo.png" width="32" class="mr-0.5">
                            <h1 class="font-xl font-bold font-grey-800">Brixi UI</h1>
                        </a>
                        <a target="_blank" rel="noopener" tooltip="Github" href="https://github.com/codewithkyle/brixi-components" class="bttn" shape="round" kind="text" color="grey" icon="center">
                        ...
                        <a target="_blank" rel="noopener" tooltip="Report issues" href="https://github.com/codewithkyle/brixi-components/issues" class="bttn" shape="round" kind="text" color="grey" icon="center">
                        ...
                        <a target="_blank" rel="noopener" tooltip="Project board" href="https://github.com/codewithkyle/brixi-components/projects/1" class="bttn" shape="round" kind="text" color="grey" icon="center">
