            ...
            default:
                view = html`
                    <div flex="row nowrap items-center" class="mb-1">
                        ...
                        <a sfx="button" target="_blank" rel="noopener" tooltip="Report issues" href="https://github.com/codewithkyle/brixi-components/issues" class="bttn" shape="round" kind="text" color="grey" icon="center">
                        ...
                        <a sfx="button" target="_blank" rel="noopener" tooltip="Project board" href="https://github.com/codewithkyle/brixi-components/projects/1" class="bttn" shape="round" kind="text" color="grey" icon="center">
