        ...
        let view = html`
            <div class="block w-full h-screen scroll-y-auto px-1">
                <div class="w-full max-w-768 mx-auto block py-4">
                    ...
                    <p class=" mb-4 font-grey-700 font-sm line-normal">The benifit of downloading the UI package instead of cherry-picking individual components is all the extra utility classes that the library provides.</p>
                    ...
                    <ul class="font-sm line-normal mb-4 list">
                        ...
                        <li>Several pre-bundled 3rd party libraries such as lit-html, flatpickr, day.js, fuse.js, tooltips, pubsub, snackbar/toaster notifications, and modal creation.</li>
                    </ul>
                    ...
                    <p class=" mb-4 font-grey-700 font-sm line-normal">Everybody, or maybe nobody. The Brixi UI design system is a tool I created to help myself create SPAs faster and easier. All of the components are licensed under MIT. Feel free to download and use any component for any commercial/non-commercial project.</p>
                    ...
                    <p class=" mb-4 font-grey-700 font-sm line-normal">That works too. Every component can be configured using <a class="link" href="https://developer.mozilla.org/en-US/docs/Learn/HTML/Howto/Use_data_attributes" target="_blank" rel="noopener">data attributes</a>. On the server all you need to do is render the empty custom element with the corresponding data attributes. When the browser loads the component's JavaScript the component will be automatically mounted and it will render it's content using the settings provided by the data attributes.</p>

                    <h2 class="block font-grey-700 font-lg font-bold mb-0.5 line-normal">Contributing to Brixi UI.</h2>
                    <p class=" mb-4 font-grey-700 font-sm line-normal">Contributions are welcome, however, this is my personal design system. Any contributions are likely to be subject to scrutiny and multiple revisions until I feel like the component fits the look and feel of the overall design system.</p>
