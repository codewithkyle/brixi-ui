module.exports = {
    ...
    fonts: {
        units: "rem",
        families: {
            base: "'Open Sans', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Helvetica Neue', sans-serif",
    ...
    variables: {
        ...
        bevel: "inset 0 -1px 1px rgba(0,0,0,0.2), 0 1px 0 rgba(0,0,0,0.05)",
        "light-bevel": "0 1px 0 rgba(0,0,0,0.05), inset 0 -1px 1px rgba(0,0,0,0.025)",
