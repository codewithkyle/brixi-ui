import{html as r,render as a}from"./lit-html.js";import s from"./env.js";import{noop as o,parseDataset as m}from"./general.js";import{default as n}from"./input.js";class l extends n{constructor(e){super(e);this.state=e?.disabled?"DISABLED":"IDLING",this.stateMachine={IDLING:{ERROR:"ERROR",DISABLE:"DISABLED"},ERROR:{RESET:"IDLING",ERROR:"ERROR"},DISABLED:{ENABLE:"IDLING"}},this.model={label:"",instructions:null,readOnly:!1,error:null,name:"",required:!1,autocomplete:"off",autocapitalize:"off",icon:null,placeholder:"",value:"",maxlength:9999,minlength:0,min:0,max:9999,step:1,disabled:!1,css:"",class:"",callback:o,attributes:{},datalist:[],autofocus:!1},this.model=m(this.dataset,this.model),s.css("input").then(()=>{this.set(e,!0),this.render()})}validate(e=null,i=!1){e||(e=this.querySelector("input"));let t=!0;return this.model.required&&!e.value.length&&(t=!1,this.setError("This field is required.",i)),(this.model.required||!this.model.required&&e.value.length)&&(parseFloat(e.value)<this.model.min?(t=!1,this.setError(`Minimum allowed number is ${this.model.min}.`,i)):parseFloat(e.value)>this.model.max&&(t=!1,this.setError(`Maximum allowed number is ${this.model.max}.`,i))),t&&this.clearError(),t}render(){const e=`${this.model.label.replace(/\s+/g,"-").trim()}-${this.model.name}`,i=r`
