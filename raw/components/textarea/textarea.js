...
${this.model.value??""}</textarea
            >
            ${this.renderCounter()}
        `;r(e,this)}}s.bind("textarea-component",a);export{a as default};
