import{html as l,render as o}from"./lit-html.js";import{unsafeHTML as a}from"./unsafe-html.js";import c from"./supercomponent.js";import r from"./env.js";import{noop as u,parseDataset as d}from"./general.js";import h from"./soundscape.js";class n extends c{constructor(e){super();this.handleChange=e=>{const t=e.currentTarget,s=parseInt(t.value),i=this.model.options[s].value;this.update({selected:s,value:i}),this.validate(t,!0),this.model.callback(i)};this.handleBlur=e=>{const t=e.currentTarget;this.validate(t)};this.state=e?.disabled?"DISABLED":"IDLING",this.stateMachine={IDLING:{ERROR:"ERROR",DISABLE:"DISABLED"},ERROR:{RESET:"IDLING",ERROR:"ERROR"},DISABLED:{ENABLE:"IDLING"}},this.model={selected:null,label:"",name:"",icon:"",instructions:"",options:e?.options??[],required:!1,error:null,value:"",disabled:!1,callback:u,css:"",class:"",attributes:{}},this.model=d(this.dataset,this.model);for(let t=0;t<this.model.options.length;t++)e?.value?this.model.options[t].value===e.value&&(this.model.selected=t):this.model.options[t].value===this.model.value&&(this.model.selected=t);r.css("select").then(()=>{this.set(e,!0),this.render()})}renderCopy(){let e;return this.state==="IDLING"&&this.model.instructions?e=l`<p>${this.model.instructions}</p>`:this.state==="ERROR"&&this.model.error?e=l`<p class="font-danger-700">${this.model.error}</p>`:e="",e}renderIcon(){let e;return this.model.icon?e=l` <i class="icon"> ${a(this.model.icon)} </i> `:e="",e}clearError(){this.state==="ERROR"&&this.trigger("RESET")}setError(e,t){t||(this.update({error:e}),this.trigger("ERROR"),h.error())}validate(e,t=!1){let s=!0;return this.model.required&&(this.model.value===""||this.model.value==null)?(s=!1,this.setError("This field is required.",t)):this.clearError(),s}getName(){return this.model.name}getValue(){return this.model.value}renderLabel(e){let t;return this.model.label?.length?t=l`<label for="${e}">${this.model.label}</label>`:t="",t}render(){const e=`${this.model.label.replace(/\s+/g,"-").trim()}-${this.model.name}`,t=l`
