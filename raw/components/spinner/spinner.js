import{html as i,render as o}from"./lit-html.js";import n from"./supercomponent.js";import s from"./env.js";import{parseDataset as l}from"./general.js";class r extends n{constructor(t){super();this.model={color:"grey",size:18,css:"",class:"",attributes:{}},this.model=l(this.dataset,this.model),s.css(["spinner"]).then(()=>{this.set(t,!0),this.render()})}render(){Object.keys(this.model.attributes).map(e=>{this.setAttribute(e,`${this.model.attributes[e]}`)}),this.style.cssText=`${this.model.css}`,this.className=this.model.class,this.model.color!=="white"?this.style.color=`var(--${this.model.color}-700)`:this.style.color="var(--white)",this.style.width="",this.style.height=`${this.model.size}px`;const t=i`
        ...
        `;o(t,this)}}s.mount("spinner-component",r);export{r as default};
